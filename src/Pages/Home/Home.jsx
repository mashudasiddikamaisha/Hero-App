        ...
        <div>
            ...
            <section className='max-w-7xl mx-auto mt-10 mb-10 px-6'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
                    {
                        apps.map((app) => (
                            <div key={app.id} className='bg-white cursor-pointer card rounded-lg shadow-md p-4 hover:shadow-lg transition'>
                                ...
                                <div className='flex justify-between items-center text-sm text-gray-500 mt-3'>
                                    <div className='flex items-center text-[#00D390] bg-[#F1F5E8] gap-2 px-2 py-1 rounded'>
                                        <img src={download} alt="download" className='h-4 w-4' /> <span>{(app.downloads / 1000).toLocaleString()}MB</span>
                                    </div>
